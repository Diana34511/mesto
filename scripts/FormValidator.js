class FormValidator {
    ...
    _setEventListeners() {
        const inputList = Array.from(this._form.querySelectorAll(this._validationProps.inputSelector));
        const buttonElement = this._form.querySelector(this._validationProps.submitButtonSelector);
